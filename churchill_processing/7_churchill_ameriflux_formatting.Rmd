...
Variables to include in internal file: Uncleaned co2, ch4, LE, H, Tau, signal strength, DOY, hour, month, U, V, W, uncleaned biomet??, met/flux energy balance calculations, u flag, Footprint model (needs eddypro re-run before this fully works)
...
U_FLAG,
U,V,W,
X_OFFSET,X_PEAK,X_10,X_30,X_50,X_70,X_90 = df$`x_90%`
