...
knitr::opts_knit$set(root.dir = 'C:/Users/dtrangmoe/Documents/Churchill/') #use this to set your directory
```
...
Load Data
```{r}
c22 = fread(input = "C:/Users/dtrangmoe/Documents/Churchill/Churchill_Met_Flux_Clean_Ameriflux_2022.csv")
c23 = fread(input = "C:/Users/dtrangmoe/Documents/Churchill/Churchill_Met_Flux_Clean_Ameriflux_2023.csv")
c24 = fread(input = "C:/Users/dtrangmoe/Documents/Churchill/Churchill_Met_Flux_Clean_Ameriflux_2024.csv")


df = rbind(c22,c23,c24,fill=T)
...
write.csv(x = df,file = "./churchill_2022_2024.csv",row.names = F)
```

Add ERA5 data
```{r}
#load in era5 data for churchill for continuous met data
era = fread('C:/Users/dtrangmoe/Documents/Churchill/era5_churchill24.csv')
...
write.csv(x = df,file = './churchill_2022_2024_era.csv',row.names = F,quote = F)
...
```{r}
png(filename = 'C:/Users/dtrangmoe/Documents/Churchill/era5_churchill_comparisons.png',width = 6,height = 4,units = 'in',res = 1500)
