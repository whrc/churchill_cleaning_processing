...
#  geom_hline(yintercept = 0)+geom_vline(xintercept = 0)+
  geom_point(alpha=0.5)+
  geom_abline(slope = 1,intercept = 0,col='red',lty=2)+
  scale_y_continuous(expression('Site Atmopsheric Pressure (kPa)'))+
  scale_x_continuous(expression('ERA5 Atmopsheric Pressure (kPa)'))+
  theme(text = element_text(size = 6))
...
plot_grid(airt,rh,ws,rad,tsoil,le,h,pres,swc)
dev.off()
```
