...
knitr::opts_knit$set(root.dir = 'C:/Users/dtrangmoe/Documents/sites/churchill/') #use this to set your directory
```
...
Load Data
```{r}
c22 = fread(input = "C:/Users/dtrangmoe/Documents/sites/churchill/data/Churchill_Met_Flux_Clean_Ameriflux_2022.csv")
c23 = fread(input = "C:/Users/dtrangmoe/Documents/sites/churchill/data/Churchill_Met_Flux_Clean_Ameriflux_2023.csv")
c24 = fread(input = "C:/Users/dtrangmoe/Documents/sites/churchill/data/Churchill_Met_Flux_Clean_Ameriflux_2024.csv")
c25 = fread(input = "C:/Users/dtrangmoe/Documents/sites/churchill/data/Churchill_Met_Flux_Clean_Ameriflux_2025.csv")
...
write.csv(x = df,file = "./data/churchill_2022_2025.csv",row.names = F)
```

Add ERA5 data
```{r}
#load in era5 data for churchill for continuous met data
era = fread('C:/Users/dtrangmoe/Documents/sites/churchill/era5/era5_churchill25.csv')
...
write.csv(x = df,file = './churchill_2022_2025_era.csv',row.names = F,quote = F)
...
```{r}
png(filename = 'C:/Users/dtrangmoe/Documents/sites/churchill/era5/era5_churchill_comparisons.png',width = 6,height = 4,units = 'in',res = 1500)
