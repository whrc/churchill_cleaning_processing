...
df <- subset(df,df$TIMESTAMP >= as.POSIXct(x = "2022-08-07 00:00", tz = "CST"))
```
...
df$PA_4_2_1_1_1.c   = na.spline(df$PA_4_2_1_1_1,maxgap = gap)
...
plot(df$TIMESTAMP,df$RH_19_3_1_1_1.c)
...
ggplot(data = all)+
  geom_point(aes(date,rad,col='ERA5'))+
  geom_point(aes(date,SWIN_6_10_1_1_1.c,col='Site'))+
  scale_x_datetime(limits = as.POSIXct(c('2023-02-23','2023-03-05')))+
  geom_vline(xintercept = as.POSIXct("2023-02-25 12:00:00"))
