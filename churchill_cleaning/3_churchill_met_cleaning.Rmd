...
```{r, warning=FALSE}
biomet_dates <- c('2022-08-01', '2025-12-01')
```
...
ggplot(data = df)+
  ...
  scale_x_datetime(limits = as.POSIXct(c("2022-08-06","2022-12-31")))
```
...
# 
# PA_4_2_1_1_1.limits <- ifelse(PA_4_2_1_1_1.limits < 60, NA ,PA_4_2_1_1_1.limits)

ggplot(data = df)+
  geom_point(aes(TIMESTAMP,PA_4_2_1_1_1.limits),col='black')+
  scale_y_continuous(#limits = c(0,200),
                     expression ('Barometric Pressure ('*kPa*')'))+
  scale_x_datetime(limits = as.POSIXct(c("2022-10-01","2023-02-05")))+
