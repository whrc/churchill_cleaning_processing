...
co2_flux.limits = ifelse(df$co2_flux > 8 | df$co2_flux < -15,1,0)
```
...
ggplot(data = df)+
  ...
  scale_x_datetime(limits = as.POSIXct(c('2025-03-03','2025-03-10'),format="%F"))+
  geom_line(aes(x = ts, y = PPFD_7_21_1_1_1.c/1000))
```
...
ggplot(data = df)+
  ...
  scale_x_datetime(limits = as.POSIXct(c('2025-04-03','2025-04-10'),format="%F"))+
