...
fp = 'C:/Users/dtrangmoe/Documents/sites/churchill/met/2025/'
#fp = './data/EP_full_output/'
files = list.files(path = fp,pattern = 'biomet_2025[0-9][0-9].+csv$',recursive = T,full.names = T)
...
df = met_list[[1]]
for (i in 2:length(met_list)) {
  df = rbind.fill(df,met_list[[i]])
}
...
write.csv(x = df,file = 'C:/Users/dtrangmoe/Documents/sites/churchill/data/Churchill_met_merged_2025.csv',row.names = F,quote = F)

# 
# 
# ## for loading in merged file
# df <- fread('C:/Users/dtrangmoe/Documents/sites/churchill/data/Churchill_met_merged_2025.csv')
...
```{r, warning=FALSE}
write.csv(x = df,file = 'C:/Users/dtrangmoe/Documents/sites/churchill/data/Churchill_met_clean_2025.csv',row.names = F,quote = F)
```
