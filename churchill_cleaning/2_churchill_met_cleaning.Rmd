...
Merge all_biomet files

```{r, warning=FALSE}

# 
# h = fread('C:/Users/dtrangmoe/Documents/Churchill/Data/Churchill_AllBiomet_until20240622.dat',skip=1 ,nrows = 0)
# dat = fread('C:/Users/dtrangmoe/Documents/Churchill/Data/Churchill_AllBiomet_until20240622.dat',skip=4, header = FALSE, na.strings=c('-9999','NA','NaN','NAN',"-7999"))
# 
# h2 = fread('C:/Users/dtrangmoe/Documents/Churchill/Data/Churchill_AllBiomet_until20240802.dat',skip=1 ,nrows = 0)
# dat2 = fread('C:/Users/dtrangmoe/Documents/Churchill/Data/Churchill_AllBiomet_until20240802.dat',skip=4, header = FALSE, na.strings=c('-9999','NA','NaN','NAN',"-7999"))
# 
# h3 = fread('C:/Users/dtrangmoe/Documents/Churchill/Data/Churchill_AllBiomet_until20250110.dat',skip=1 ,nrows = 0)
# dat3 = fread('C:/Users/dtrangmoe/Documents/Churchill/Data/Churchill_AllBiomet_until20250110.dat',skip=4, header = FALSE, na.strings=c('-9999','NA','NaN','NAN',"-7999"))
# 
# names(dat) = names(h)
# names(dat2) = names(h2)
# names(dat3) = names(h3)
...
# 
# #Isolate 2024 Data
# df <- subset(df, df$TIMESTAMP > as.POSIXct('2023-12-31 23:30'))
# df <- subset(df, df$TIMESTAMP < as.POSIXct('2025-01-01 00:30'))
# 
# write.csv(x = df,file = 'C:/Users/dtrangmoe/Documents/Churchill/Data/Churchill_met_merged2024.csv',row.names = F,quote = F)



## for loading in merged file
df <- fread('C:/Users/dtrangmoe/Documents/Churchill/Data/Churchill_met_merged2024.csv')
...
```{r, warning=FALSE}
biomet_dates <- c('2024-01-01', '2024-12-31')
```
...
ggplot(data = df)+
  ...
  geom_vline(xintercept = as.POSIXct("2024-10-23"), color = "red")
...
SD_10_99_1_1_1.limits = ifelse(df$SD_10_99_1_1_1 > 0.2 & df$TIMESTAMP > as.POSIXct('2024-05-10') & df$TIMESTAMP < as.POSIXct('2024-10-23') ,NA,SD_10_99_1_1_1.limits)
...
scale_x_datetime(limits = as.POSIXct(c('2024-10-15','2024-11-25'),format="%F"))
...
ggplot(data = df)+
  ...
  scale_x_datetime(limits = as.POSIXct(c('2024-06-15', '2024-12-31')))+
  geom_vline(aes(xintercept = as.POSIXct('2024-10-24'))) #for cutting freezing water table depth data
...
df$WTD_10_42_1_1_1.c <- ifelse(df$TIMESTAMP > as.POSIXct('2024-10-24'), NA, df$WTD_10_42_1_1_1)
...
ggplot(data = df)+
  ...
  scale_y_continuous(#limits = c(150,750),
                     expression('Water Table Depth (m)'))+
  scale_x_datetime(limits = as.POSIXct(c('2024-06-15', '2024-12-31')))+
  geom_vline(aes(xintercept = as.POSIXct('2024-10-24'))) 
