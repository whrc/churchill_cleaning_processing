...
df <- subset(df, df$TIMESTAMP > as.POSIXct('2023-01-01'))
```
...
plot(df$TIMESTAMP,df$SD_10_99_1_1_1,ylim = c(-1.5,1));abline(h=0, col= 'red');abline(h=.7, col='red')

SD_10_99_1_1_1.limits=df$SD_10_99_1_1_1
SD_10_99_1_1_1.limits = ifelse(df$SD_10_99_1_1_1 < 0 | df$SD_10_99_1_1_1 > .7,NA,df$SD_10_99_1_1_1)
